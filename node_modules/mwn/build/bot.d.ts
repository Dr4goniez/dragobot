...
import type { ApiDeleteResponse, ApiEditResponse, ApiMoveResponse, ApiPage, ApiQueryResponse, ApiResponse, ApiRevision, ApiRollbackResponse, ApiSearchResult, ApiUndeleteResponse, ApiUploadResponse } from './api_response_types';
...
export declare class Mwn {
    ...
    query(params: ApiParams, customRequestOptions?: RawRequestParams): Promise<ApiQueryResponse>;
    /************** CORE FUNCTIONS *******************/
    /**
     * Executes a Login
    ...
    read(titles: string[] | number[] | MwnTitle[], options?: ApiParams): Promise<ApiPage[]>;
    readGen(titles: string[], options?: ApiParams, batchSize?: number): AsyncGenerator<ApiPage>;
    /**
     ...
     */
    edit(title: string | number, transform: EditTransform, editConfig?: EditConfig): Promise<ApiEditResponse>;
    /**
     ...
     * @returns {Promise}
     */
    delete(title: string | number, summary: string, options?: ApiDeleteParams): Promise<ApiDeleteResponse>;
    /**
     * Undeletes a page.
     ...
     * @returns {Promise}
     */
    undelete(title: string, summary: string, options?: ApiUndeleteParams): Promise<ApiUndeleteResponse>;
    /**
     * Moves a new page
     *
     ...
     * @param {object}  [options]
     */
    move(fromtitle: string, totitle: string, summary: string, options?: ApiMoveParams): Promise<ApiMoveResponse>;
    /**
     ...
     */
    upload(filepath: string, title: string, text: string, options?: ApiUploadParams): Promise<ApiUploadResponse>;
    /**
     ...
     * @returns {Promise<Object>}
     */
    uploadFromUrl(url: string, title: string, text: string, options?: ApiUploadParams): Promise<ApiUploadResponse>;
    /**
     ...
     * @return {Promise}
     */
    rollback(page: string | number, user: string, params?: ApiRollbackParams): Promise<ApiRollbackResponse>;
    /**
     ...
     * @returns {Promise<Object>}
     */
    search(searchTerm: string, limit?: number | 'max', props?: ApiQuerySearchParams['srprop'], otherParams?: ApiQuerySearchParams): Promise<ApiSearchResult[]>;
...
export declare class mwn extends Mwn {
}
