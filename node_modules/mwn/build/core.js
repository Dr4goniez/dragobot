...
class Response {
        ...
        if (this.response.warnings && !this.bot.options.suppressAPIWarnings) {
            if (Array.isArray(this.response.warnings)) {
                ...
                for (let { code, module, info, html, text } of this.response.warnings) {
                    ...
                    log_1.log(`[W] Warning received from API: ${module}: ${msg}`);
                }
            }
            else {
    ...
    async handleErrors() {
        ...
        let error = this.response.error || // errorformat=bc (default)
         ((_a = this.response.errors) === null || _a === void 0 ? void 0 : _a[0]); // other error formats
        if (error) {
    ...
    logError(err) {
        ...
        log_1.log(`[W] Retrying in ${this.bot.options.retryPause / 1000} seconds: encountered ${err}`);
        const errorData = {
            request: {
                method: (_a = err === null || err === void 0 ? void 0 : err.request) === null || _a === void 0 ? void 0 : _a.method,
                path: (_b = err === null || err === void 0 ? void 0 : err.request) === null || _b === void 0 ? void 0 : _b.path,
            },
            response: {
                status: (_c = err === null || err === void 0 ? void 0 : err.response) === null || _c === void 0 ? void 0 : _c.status,
                statusText: (_d = err === null || err === void 0 ? void 0 : err.response) === null || _d === void 0 ? void 0 : _d.statusText,
                headers: (_e = err === null || err === void 0 ? void 0 : err.response) === null || _e === void 0 ? void 0 : _e.headers,
