...
exports.mwn = exports.Mwn = exports.Template = void 0;
/**
 * Attributions:
...
__exportStar(require("./api_response_types"), exports);
var wikitext_2 = require("./wikitext");
Object.defineProperty(exports, "Template", { enumerable: true, get: function () { return wikitext_2.Template; } });
class Mwn {
    /**
        ...
        if (data) {
            if (data.result === 'Success') {
                ...
                await this.getTokensAndSiteInfo().catch((err) => {
                    log_1.log(`[W] Failed fetching tokens and siteinfo: ${err}`);
                });
                return data;
            }
     ...
     * @returns {Promise<void>}
     */
    async loginGetToken(loginOptions) {
    ...
    oresQueryRevisions(endpointUrl, models, revisions) {
        ...
        const chunks = utils_1.arrayChunk(revs, batchSize);
