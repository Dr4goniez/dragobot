 ...
 * @private
 */
export type _HelpFlags = 'deprecated' | 'internal' | 'readrights' | 'writerights' | 'mustbeposted';
/**
...
export interface ApiResponseParaminfoModules extends PartialRecord<_HelpFlags, true> {
    name: string;
    classname: string;
    path: string;
    group?: string;
...
export interface ApiResponsePurge extends _PageSetInvalidTitlesAndRevisions {
    purged?: true;
    linkupdate?: true;
}
...
export interface ApiResponseQuery {
    ...
    threads?: {
        [thread_id: string]: ApiResponseQueryListThreads;
    };
...
export interface ApiResponseQueryPagesPropCategories extends _TitleInfo {
    sortkey?: string;
...
export interface ApiResponseQueryMetaSiteinfoUsergroups extends Partial<_GroupsChangeableBy> {
    name: string;
    rights: string[];
    number?: number;
}
export type ApiResponseQueryMetaSiteinfoVariables = string;
export type ApiResponseQueryMetaTokens = {
    csrftoken?: string;
    watchtoken?: string;
    patroltoken?: string;
...
export interface ApiResponseQueryListAbuselog extends Partial<_TitleInfo> {
    id?: number;
    filter_id?: string;
    filter?: string;
    user?: string;
...
export type ApiResponseQueryListAlldeletedrevisions = ApiResponseQueryListAllrevisions;
export type ApiResponseQueryListAllfileusages = ApiResponseQueryListAlllinks;
export type ApiResponseQueryListAllimages = _TitleInfo & ApiResponseQueryPagesPropImageinfo;
export interface ApiResponseQueryListAlllinks extends Partial<_TitleInfo> {
    fromid?: number;
}
export interface ApiResponseQueryListAllpages extends _TitleInfo {
    pageid: number;
}
export interface ApiResponseQueryListAllredirects extends ApiResponseQueryListAlllinks {
    fragment?: string;
    interwiki?: string;
}
export interface ApiResponseQueryListAllrevisions extends Partial<_TitleInfo> {
    pageid?: number;
    revisions: ApiResponseQueryPagesPropRevisions[];
}
export type ApiResponseQueryListAlltransclusions = ApiResponseQueryListAlllinks;
export interface ApiResponseQueryListAllusers extends _BlockDetails, _CentralUserInfo {
    userid: number;
    name: string;
    hidden?: true;
    editcount?: number;
...
export interface ApiResponseQueryListCategorymembers extends Partial<_TitleInfo> {
    pageid?: number;
    sortkey?: string;
    sortkeyprefix?: string;
    type?: string;
...
export interface ApiResponseQueryListCodexicons {
    [key: string]: unknown;
}
...
export interface ApiResponseQueryListExturlusage extends _TitleInfo {
    pageid?: number;
    url?: string;
}
export interface ApiResponseQueryListFilearchive extends _TitleInfo {
    id: number;
    name: string;
...
export interface ApiResponseQueryListIwbacklinks extends _TitleInfo {
    pageid: number;
    redirect?: true;
    iwprefix?: string;
    iwtitle?: string;
}
export interface ApiResponseQueryListLangbacklinks extends _TitleInfo {
    pageid: number;
    redirect?: true;
    lllang?: string;
    lltitle?: string;
}
export interface ApiResponseQueryListLinterrors extends _TitleInfo {
    pageid: number;
    lintId: number;
...
export interface ApiResponseQueryListMostviewed extends _TitleInfo {
    count: number;
}
...
export interface ApiResponseQueryListPageswithprop extends Partial<_TitleInfo> {
    pageid?: number;
    value?: string;
}
export interface ApiResponseQueryListPrefixsearch extends _TitleInfo {
    special?: true;
    pageid?: number;
}
export interface ApiResponseQueryListProtectedtitles extends _TitleInfo {
    timestamp?: string;
    user?: string;
    userid?: number;
    comment?: string;
...
export interface ApiResponseQueryListRandom extends _TitleInfo {
    id: number;
    redirect?: boolean;
}
export interface ApiResponseQueryListRecentchanges extends Partial<_TitleInfo> {
 ...
 */
export type ApiResponseQueryListRecentchangesTypes = 'edit' | 'new' | 'log' | 'external' | 'categorize';
export interface ApiResponseQueryListSearch extends _TitleInfo {
    pageid: number;
    size?: number;
    wordcount?: number;
    snippet?: string;
...
export interface ApiResponseQueryListSearchInfoInterwiki {
    totalhits?: number;
    approximate_totalhits?: number;
}
export interface ApiResponseQueryListSearchInfo extends ApiResponseQueryListSearchInfoInterwiki {
    suggestion?: string;
    suggestionsnippet?: string;
    rewrittenquery?: string;
    rewrittenquerysnippet?: string;
}
export interface ApiResponseQueryListSearchInterwikisearch extends ApiResponseQueryListSearch {
    namespace: string;
    title: string;
    url: string;
}
...
export type ApiResponseQueryListTagsSource = 'software' | 'extension' | 'manual';
export interface ApiResponseQueryListThreads {
    ...
    type?: string;
    reactions?: [] | {
        [key: string]: ApiResponseQueryListThreadsReactions;
    };
    replies?: [] | {
        [thread_id: string]: ApiResponseQueryListThreadsReplies;
    };
    /**
     * `thrender=true`
     */
...
export interface ApiResponseQueryListUsercontribs extends _TitleInfo {
    texthidden?: true;
    userid: number;
    user: string;
    userhidden?: true;
...
export interface ApiResponseQueryListUsers extends _BlockDetails, _CentralUserInfo {
    name: string;
    invalid?: true;
    userid?: number;
    systemuser?: true;
...
export interface ApiResponseQueryListWatchlist extends Partial<_TitleInfo> {
    type: ApiResponseQueryListRecentchangesTypes;
    actionhidden?: true;
    pageid?: number;
    revid?: number;
...
export interface ApiResponseQueryListWatchlistraw extends _TitleInfo {
    changed?: string;
}
export interface ApiResponseQueryListWblistentityusage extends _TitleInfo {
    pageid: number;
